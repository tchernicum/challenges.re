...
_HEADER_HL1(`Reverse Engineering challenge #29.')

<!-- Это очень короткая программа, скомпилированная моим пропатченным компилятором Tiny C -->
...
<p>_HTML_LINK(`files/obfuscation.rar',`obfuscation.rar')</p>
