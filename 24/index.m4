...
<ul>
<li> _HTML_LINK(`http://challenges.re/24/files/calc_linux_x64.tar',`GCC 4.8.2 for Linux x64')
<li> _HTML_LINK(`http://challenges.re/24/files/calc_MIPS.tar',`GCC 4.4.5 for MIPS')
<li> _HTML_LINK(`http://challenges.re/24/files/calc_ARM_Raspberry.tar',`GCC 4.6.3 for ARM (Raspberry Pi)')
<li> _HTML_LINK(`http://challenges.re/24/files/calc_MSVC2013.exe',`MSVC 2013, Windows x64')
</ul>
